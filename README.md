...
This two sales KPIs are available on daily basis and the range of 7 days starting from a given day.

As an input, 2 Data files type are available: Transactions and Product Data, the structure of this Data files is detailed in the next section.
## Data Structure
-----------
...
### com.phenix.model
This package makes the tool easier to use and upgrade if needed. It contains 4 classes for Data modeling and processing with the factory Pattern.
 - **Data** : `Interface`
